            ...
            NodeDataCtrl = (function (_super) {
                ...
                NodeDataCtrl.prototype.loadCluster = function () {
                    ...
                    if (!cluster) {
                        ...
                        var heiliDS = lodash_1.default.find(this.templateVariables, { 'name': 'datasource' }).current.value;
                        this.loadDatasource(cluster_id).then(function () {
                            return _this.nodeStatsDatasource.getNodeStats(cluster_id, heiliDS);
                ...
                NodeDataCtrl.prototype.loadDatasource = function (id) {
                    ...
                    return this.backendSrv.get('api/datasources')
                        ...
                        return lodash_1.default.filter(result, { "type": "heili-kubernetes-datasource", "name": id })[0];
                    })
                        .then(function (ds) {
                        if (!ds) {
