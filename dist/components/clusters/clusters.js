            ...
            ClustersCtrl = (function () {
                ...
                ClustersCtrl.prototype.getClusters = function () {
                    ...
                    return this.backendSrv.get('/api/datasources')
                        ...
                        self.clusters = lodash_1.default.filter(result, { "type": "heili-kubernetes-datasource" });
                    });
                };
                ...
                ClustersCtrl.prototype.clusterInfo = function (cluster) {
                    this.$location.path("plugins/heili-kubernetes-app/page/cluster-info").search({ "cluster": cluster.id });
                };
