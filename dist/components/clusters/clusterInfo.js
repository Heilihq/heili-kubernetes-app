    ...
    return {
        ...
        execute: function() {
            ClusterInfoCtrl = (function () {
                ...
                ClusterInfoCtrl.prototype.goToDeploymentDashboard = function () {
                ...
                ClusterInfoCtrl.prototype.goToWorkloads = function (ns, evt) {
                    var clickTargetIsLinkOrHasLinkParents = jquery_1.default(evt.target).closest('a').length > 0;
                    if (clickTargetIsLinkOrHasLinkParents === false) {
                        this.$location.path("plugins/heili-kubernetes-app/page/cluster-workloads")
                            .search({
                ...
                ClusterInfoCtrl.prototype.goToNodeInfo = function (node, evt) {
                    ...
                    if (clickTargetIsLinkOrHasLinkParents === false &&
                        ...
                        this.$location.path("plugins/heili-kubernetes-app/page/node-info")
                            .search({
                            "cluster": this.cluster.id,
